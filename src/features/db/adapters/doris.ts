...
// Apache Doris exposes a MySQL-compatible query interface, so it reuses every
...
export class DorisAdapter extends MySqlAdapter {
  override readonly kind = "doris" as const;
  ...
  override badge(): DbConnectionBadge {
    return { label: "DORIS", class: "theme-method-badge theme-method-get" };
  }
